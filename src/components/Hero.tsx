...
import { Github, Linkedin, ArrowRight, Mail, Code2, Download } from 'lucide-react';
          ...
          <div className="lg:col-span-7 flex flex-col items-start text-left">
            ...
            <div className="flex items-center gap-2 mb-6 flex-wrap">
              ...
              <span className="text-xs sm:text-sm text-slate-400 font-mono flex items-center gap-1.5">
                ...
                {profile.degree ? `${profile.degree} • ${profile.university}` : 'Software Developer'}
              </span>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-4 w-full sm:w-auto mb-8">
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-lg bg-[#141414] hover:bg-white/5 text-blue-400 font-bold text-sm border border-blue-500/30 transition-all shadow-sm active:scale-95 cursor-pointer"
            ...
            <div className="pt-6 border-t border-white/5 grid grid-cols-2 sm:grid-cols-3 gap-4 text-xs text-slate-400 font-mono w-full">
              <div>
                <span className="block text-slate-500 text-[10px] uppercase font-bold tracking-wider">Role</span>
                <span className="text-white font-medium">{profile.role}</span>
              </div>
              <div>
                <span className="block text-slate-500 text-[10px] uppercase font-bold tracking-wider">Degree</span>
                <span className="text-white font-medium">{profile.degree || 'BS Computer Science'}</span>
              </div>
              <div className="col-span-2 sm:col-span-1">
                <span className="block text-slate-500 text-[10px] uppercase font-bold tracking-wider">Location</span>
            ...
            <div className="relative group flex flex-col items-center">
              ...
              <div className="w-64 h-64 sm:w-80 sm:h-80 lg:w-[350px] lg:h-[350px] p-2.5 rounded-full bg-[#141414] border-2 border-white/10 shadow-2xl shadow-black/90 ring-2 ring-blue-500/20 group-hover:ring-blue-500/40 transition-all duration-300 relative">
                ...
                <div className="absolute bottom-2 right-2 sm:bottom-4 sm:right-4 bg-[#141414]/90 border border-white/15 px-3 py-1.5 rounded-full backdrop-blur-md shadow-lg flex items-center gap-2 z-20">
                  ...
                  <span className="text-[11px] font-bold text-white tracking-wide">Available for Hire</span>
                </div>
